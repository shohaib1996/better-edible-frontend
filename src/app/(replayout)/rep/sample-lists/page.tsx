  ...
  const columns: Column<ISample>[] = [
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="font-semibold text-foreground truncate max-w-[280px] cursor-pointer">
        ...
        <>
          ...
          <div className="hidden md:block">
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="text-sm text-muted-foreground max-w-[250px] truncate cursor-pointer hover:text-foreground transition-colors">
    ...
    },
    {
      ...
      render: (sample) => (
        <Select
          value={sample.status}
          onValueChange={(val) => handleStatusChange(sample._id, val)}
        >
          <SelectTrigger
            className={`w-[130px] h-8 capitalize rounded-xs text-xs font-medium ${getStatusStyles(
              sample.status
            )}`}
          >
            <SelectValue />
  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold text-foreground">Sample List</h1>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-3 bg-card rounded-xs border border-border">
