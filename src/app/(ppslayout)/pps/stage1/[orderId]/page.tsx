      ...
      <CardContent className="flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {item.colorComponents.map((cc) => (
                <Badge key={cc.name} variant="outline" className="text-xs border-violet-500/40 text-violet-600">
        ...
        {isComplete ? (
          ...
          <div className="border-t pt-3 flex flex-col gap-2">
            {mode === "idle" && (
              <Button variant="outline" className="w-full" onClick={() => setMode("molding")}>
                Start
              </Button>
            )}
            ...
            {mode === "molding" && (
              <>
                <Button className="w-full" onClick={() => setMode("scanning")}>
                  Mold
                </Button>
                {item.assignedMoldIds.length > 0 && (
                  <Button
